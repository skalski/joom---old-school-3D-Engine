...
public class ScreenHandler {
    ...
    private ArrayList<TextureHandler> textures;

    public ScreenHandler(int[][] m, int mapW, int mapH, ArrayList<TextureHandler> tex, int w, int h) {
        map = m;
        mapWidth = mapW;
        mapHeight = mapH;
        textures = tex;
    ...
    public int[] update(CameraHandler camera, int[] pixels) {
        ...
        for(int x=0; x<width; x=x+1) {
            ...
            for(int y=drawStart; y<drawEnd; y++) {
                ...
                if(side==0){
                    ...
                    color = (textures.get(texNum).pixels[texX + (texY * textures.get(texNum).getSize())]>>1) & 8355711;
                }
